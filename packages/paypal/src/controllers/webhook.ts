...
import { verifyWebhookRequestSchema, VerifyWebhookSchema, verifyWebhookSchema } from '../schema';
...
export class WebhookController extends BaseController {
  async verifyWebhook(body: {
    ...
    const mapped = req.prepareArgs({ body: [body, verifyWebhookRequestSchema] });
