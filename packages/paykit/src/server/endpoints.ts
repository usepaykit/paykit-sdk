...
export interface PayKitEndpoints {
  ...
  '/customer/update': {
    args: [id: string, params: UpdateCustomerParams];
    return: Customer;
  };
  ...
  '/checkout/update': {
    args: [id: string, params: UpdateCheckoutSchema];
    return: Checkout;
  };
  '/checkout/delete': { args: [id: string]; return: null };

  '/subscription/create': {
    args: [params: CreateSubscriptionSchema];
    return: Subscription;
  };
  ...
  '/payment/capture': {
    args: [id: string, params: CapturePaymentSchema];
    return: Payment;
  };
...
export type EndpointHandler<T extends EndpointPath> = (
  ...args: EndpointArgs<T>
